...
class Acvae():
    ...
    def __init__(self, args):
        ...
        self.occu_in = Input(shape=self.enviro_pdim, name='occu_in')
        self.occu_Conv1 = Conv2D(6, kernel_size=2, strides=1, padding='same', activation='relu', name='occu_Conv1')(self.occu_in)
        self.occu_MP1 = MaxPooling2D(pool_size=(2, 2), strides=1, padding='same', name='occu_MP1')(self.occu_Conv1)
        ...
        self.occus_in = Input(shape=(self.obs_seq, self.enviro_pdim[0], self.enviro_pdim[1], self.enviro_pdim[2]), name='occus_in')
        ...
        self.y_occus_in = Input(shape=(self.pred_seq, self.enviro_pdim[0], self.enviro_pdim[1], self.enviro_pdim[2]), name='y_occus_in')
        self.y_occus_layers = TimeDistributed(self.occu_model, name='y_occus_layers')(self.y_occus_in)
        ...
        self.y_occus_out = LSTM(self.hidden_size,
                          ...
                          stateful=False,
                          dropout=self.o_drop,
                          name='y_occus_out')(self.y_att_layer)    
